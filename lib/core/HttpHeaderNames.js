...
module.exports = {
    ...
    // Select operation
    SELECT_SOURCE_TYPE: 'x-ms-select-source-type',              // Supported: CSV
    SELECT_SOURCE_COLUMN_DELIM: 'x-ms-select-source-column-delim',
    SELECT_SOURCE_ROW_DELIM: 'x-ms-select-source-row-delim',
    SELECT_DEST_TYPE: 'x-ms-select-dest-type',              // Supported: CSV
    SELECT_DEST_COLUMN_DELIM: 'x-ms-select-dest-column-delim',
    SELECT_DEST_ROW_DELIM: 'x-ms-select-dest-row-delim',
