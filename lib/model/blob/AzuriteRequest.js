...
class AzuriteRequest {
    ...
    _initHttpProps(httpHeaders) {
        ...
        // SELECT headers
        this.httpProps[N.SELECT_SOURCE_TYPE] = httpHeaders[N.SELECT_SOURCE_TYPE];
        this.httpProps[N.SELECT_SOURCE_COLUMN_DELIM] = httpHeaders[N.SELECT_SOURCE_COLUMN_DELIM];
        this.httpProps[N.SELECT_SOURCE_ROW_DELIM] = httpHeaders[N.SELECT_SOURCE_ROW_DELIM];
        this.httpProps[N.SELECT_DEST_TYPE] = httpHeaders[N.SELECT_DEST_TYPE];
        this.httpProps[N.SELECT_DEST_COLUMN_DELIM] = httpHeaders[N.SELECT_DEST_COLUMN_DELIM];
        this.httpProps[N.SELECT_DEST_ROW_DELIM] = httpHeaders[N.SELECT_DEST_ROW_DELIM];
